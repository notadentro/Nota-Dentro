...
- **Simulador de Leitura Rítmica (Motor Proprietário "Ritmo Insano"):** Um módulo focado em percepção rítmica inspirado em jogos como _Guitar Hero_. Construído com a **Web Audio API**, ele apresenta:
  ...
  - **Estrutura de Níveis e Mundos:** 60 fases distribuídas em 6 mundos progressivos, cobrindo desde figuras básicas (Semibreves, Mínimas) até síncopes e polirritmias complexas.
  - **Dificuldade Dinâmica:** Fases disponíveis em 3 velocidades (Fácil - 60 BPM, Médio - 70 BPM, Insano - 90 BPM). O progresso do aluno é salvo independentemente para cada dificuldade.
  - **Modo Treino (Retry-Free):** Fases já concluídas podem ser jogadas novamente sem o custo de "Vidas". Apenas novas fases consomem vidas em caso de erro, incentivando a prática contínua sem punições.
  - **Recompensas e Game Over:** Precisão superior a 80% garante avanço e XP. Precisão quase perfeita (&ge; 98%) concede um bônus de "Cachê". Falhar esgota tentativas locais antes de decretar _Game Over_ e consumir uma Vida Global.
