...
import { CircleUser, Music4, GitBranch, ArrowRight, Star, ShieldCheck } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-gray-100 overflow-x-hidden selection:bg-primary selection:text-black">
      ...
      <footer className="w-full bg-zinc-950 border-t border-zinc-900 py-8">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Logo className="h-6 w-auto grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all" />
          </div>
          <p className="text-sm text-zinc-500">
            © {new Date().getFullYear()} Nota Dentro. Todos os direitos reservados.
          </p>
          <nav className="flex gap-6">
            <Link className="text-sm text-zinc-500 hover:text-primary transition-colors" href="#">
              Termos de Serviço
            </Link>
            <Link className="text-sm text-zinc-500 hover:text-primary transition-colors" href="#">
              Privacidade
